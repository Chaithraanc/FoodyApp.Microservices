...
using Foody.Services.OrderAPI.Extensions;
using Foody.Services.OrderAPI.MappingConfig;
using Foody.Services.OrderAPI.Service;
...
builder.Services.AddSwaggerGen(option =>
{
    ...
    {
        Title = "Foody.Services.OrderAPI",
        Version = "v1",
        Description = "Foody.Services.OrderAPI"
    });
